...
<div class="row">
	<div class="col-sm-6 mx-auto">
		...
		<img src="${contextPath}/member/avata/${member.userId}" class="rounded-circle avata-sm" >
			 ${member.userId}</div>
...
<div class="text-center">
	<a href="change-password" class="btn btn-primary text-white"> <i
		class="fas fa-edit"></i> 비밀번호 변경
	</a> <a href="edit" class="btn btn-primary text-white"> <i
