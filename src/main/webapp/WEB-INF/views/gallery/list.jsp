			...
			<div class="card w-100">
				<div style="overflow: hidden; height: 250px">
					<img class="card-img-top"
						src="${contextPath}/gallery/image/${gallery.random}">
				</div>
				<div class="card-body">
					<p class="float-right">
						<i class="far fa-heart text-danger"></i> ${gallery.readCnt}
					</p>
					<h5 class="card-title">
						<a href="view/${gallery.galleryId}?page=${pi.page}">
							${gallery.title} <span class="badge badge-pill badge-success">
								${gallery.list.size()}</span>
						</a> <sup><iot:newToday test="${gallery.regDate}" /> </sup>
					</h5>
					<p class="card-text"><img src="${contextPath}/member/avata/${gallery.owner}"
					class="rounded-circle avata-sm" > ${gallery.owner}</p>
					<p class="card-text">
